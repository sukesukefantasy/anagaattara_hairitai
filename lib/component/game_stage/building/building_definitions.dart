...
class BuildingDefinition {
  final String type;
  final Vector2 defaultSize; // 各建物のデフォルトのサイズ（静的）... スプライトのsrcSize を使用している。
